...
/****** THE INTRODUCTION OF THE TWO FUNCTIONS BELOW APPEARS TO BREAK 
		THE COMPILER. 
		-----
		sudo clm -IL ../lib/stdLib skeleton2_breaks_compiler
		Compiling skeleton2_breaks_compiler
		Run time error, selector does not matchclm: reading compiler result failed: No such file or directory
*******/
